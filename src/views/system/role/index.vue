...
<script>
import { addOrUpdateRole, dataScope, delRole, getRole, pageRole } from '@/api/system/role'
import { listMenu, roleMenuByRoleId } from '@/api/system/menu'
...
export default {
  ...
  methods: {
    ...
    getRoleMenuTreeselect(id) {
      return roleMenuByRoleId(id).then(response => {
